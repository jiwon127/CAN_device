...
uint32_t Engine_distance_data[sizeof(distance)]={0,};
uint32_t Mission_distance_data[sizeof(distance)]={0,};
uint32_t Break_distance_data[sizeof(distance)]={0,};
...
int main()
{
    ...
    memcpy(&Engine_distance, Engine_distance_data, sizeof(Engine_distance)-1);
    memcpy(&Mission_distance, Mission_distance_data, sizeof(Mission_distance)-1);
    memcpy(&Break_distance, Break_distance_data, sizeof(Break_distance)-1);

    Engine_int_distance = (int)Engine_distance;
    Mission_int_distance= (int)Mission_distance;
    Break_int_distance= (int)Break_distance;
...
/*
    ...
    memcpy(&Engine_distance, Engine_distance_data, sizeof(Engine_distance_data));
    memcpy(&Mission_distance, Mission_distance_data, sizeof(Mission_distance_data));
    memcpy(&Break_distance, Break_distance_data, sizeof(Break_distance_data));
    //memcpy(&Engine_distance, Engine_distance_data, sizeof(Engine_distance)-1);
    //memcpy(&Mission_distance, Mission_distance_data, sizeof(Mission_distance)-1);
    //memcpy(&Break_distance, Break_distance_data, sizeof(Break_distance)-1);
